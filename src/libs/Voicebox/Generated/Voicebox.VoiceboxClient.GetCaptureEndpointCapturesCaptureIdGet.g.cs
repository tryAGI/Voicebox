...
namespace Voicebox
{
    ...
    {
        partial void PrepareGetCaptureEndpointCapturesCaptureIdGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string captureId);
        partial void PrepareGetCaptureEndpointCapturesCaptureIdGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string captureId);
        partial void ProcessGetCaptureEndpointCapturesCaptureIdGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetCaptureEndpointCapturesCaptureIdGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Voicebox.CaptureResponse> GetCaptureEndpointCapturesCaptureIdGetAsync(
            string captureId,
            global::Voicebox.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetCaptureEndpointCapturesCaptureIdGetAsResponseAsync(
                captureId: captureId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Voicebox.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Voicebox.AutoSDKHttpResponse<global::Voicebox.CaptureResponse>> GetCaptureEndpointCapturesCaptureIdGetAsResponseAsync(
            string captureId,
            global::Voicebox.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetCaptureEndpointCapturesCaptureIdGetArguments(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Voicebox.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Voicebox.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetCaptureEndpointCapturesCaptureIdGet",
                                methodName: "GetCaptureEndpointCapturesCaptureIdGetAsync",
                                pathTemplate: "$\"/captures/{captureId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetCaptureEndpointCapturesCaptureIdGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Voicebox.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetCaptureEndpointCapturesCaptureIdGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
