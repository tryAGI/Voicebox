...
namespace Voicebox
{
    ...
    {
        partial void PrepareTrimStoryItemStoriesStoryIdItemsItemIdTrimPutArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string storyId,
            ref string itemId,
            global::Voicebox.StoryItemTrim request);
        partial void PrepareTrimStoryItemStoriesStoryIdItemsItemIdTrimPutRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string storyId,
            string itemId,
            global::Voicebox.StoryItemTrim request);
        partial void ProcessTrimStoryItemStoriesStoryIdItemsItemIdTrimPutResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessTrimStoryItemStoriesStoryIdItemsItemIdTrimPutResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Voicebox.StoryItemDetail> TrimStoryItemStoriesStoryIdItemsItemIdTrimPutAsync(
            string storyId,
            string itemId,
        ...
        {
            var __response = await TrimStoryItemStoriesStoryIdItemsItemIdTrimPutAsResponseAsync(
                storyId: storyId,
                itemId: itemId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Voicebox.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Voicebox.AutoSDKHttpResponse<global::Voicebox.StoryItemDetail>> TrimStoryItemStoriesStoryIdItemsItemIdTrimPutAsResponseAsync(
            string storyId,
            string itemId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareTrimStoryItemStoriesStoryIdItemsItemIdTrimPutArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Voicebox.PathBuilder(
                                path: $"/stories/{storyId}/items/{itemId}/trim",
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareTrimStoryItemStoriesStoryIdItemsItemIdTrimPutRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Voicebox.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Voicebox.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "TrimStoryItemStoriesStoryIdItemsItemIdTrimPut",
                                methodName: "TrimStoryItemStoriesStoryIdItemsItemIdTrimPutAsync",
                                pathTemplate: "$\"/stories/{storyId}/items/{itemId}/trim\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessTrimStoryItemStoriesStoryIdItemsItemIdTrimPutResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Voicebox.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessTrimStoryItemStoriesStoryIdItemsItemIdTrimPutResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Voicebox.StoryItemDetail> TrimStoryItemStoriesStoryIdItemsItemIdTrimPutAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Voicebox.StoryItemTrim
            {
                TrimEndMs = trimEndMs,
                TrimStartMs = trimStartMs,
            };

            return await TrimStoryItemStoriesStoryIdItemsItemIdTrimPutAsync(
                storyId: storyId,
                itemId: itemId,
                request: __request,
                requestOptions: requestOptions,
