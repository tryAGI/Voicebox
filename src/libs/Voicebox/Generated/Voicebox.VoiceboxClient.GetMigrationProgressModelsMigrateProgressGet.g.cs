...
namespace Voicebox
{
    ...
    {
        partial void PrepareGetMigrationProgressModelsMigrateProgressGetArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareGetMigrationProgressModelsMigrateProgressGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessGetMigrationProgressModelsMigrateProgressGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetMigrationProgressModelsMigrateProgressGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Get Migration Progress<br/>
        /// Get model migration progress via Server-Sent Events.
        /// </summary>
        /// <param name="requestOptions">Per-request overrides such as headers, query parameters, timeout, retries, and response buffering.</param>
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Voicebox.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<string> GetMigrationProgressModelsMigrateProgressGetAsync(
            global::Voicebox.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetMigrationProgressModelsMigrateProgressGetAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Voicebox.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Voicebox.AutoSDKHttpResponse<string>> GetMigrationProgressModelsMigrateProgressGetAsResponseAsync(
            global::Voicebox.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetMigrationProgressModelsMigrateProgressGetArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetMigrationProgressModelsMigrateProgressGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Voicebox.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Voicebox.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetMigrationProgressModelsMigrateProgressGet",
                                methodName: "GetMigrationProgressModelsMigrateProgressGetAsync",
                                pathTemplate: "\"/models/migrate/progress\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetMigrationProgressModelsMigrateProgressGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Voicebox.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetMigrationProgressModelsMigrateProgressGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
