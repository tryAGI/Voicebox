...
namespace Voicebox
{
    ...
    {
        partial void PrepareDeleteCaptureEndpointCapturesCaptureIdDeleteArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string captureId);
        partial void PrepareDeleteCaptureEndpointCapturesCaptureIdDeleteRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string captureId);
        partial void ProcessDeleteCaptureEndpointCapturesCaptureIdDeleteResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDeleteCaptureEndpointCapturesCaptureIdDeleteResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> DeleteCaptureEndpointCapturesCaptureIdDeleteAsync(
            string captureId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Voicebox.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Voicebox.AutoSDKHttpResponse<string>> DeleteCaptureEndpointCapturesCaptureIdDeleteAsResponseAsync(
            string captureId,
            global::Voicebox.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeleteCaptureEndpointCapturesCaptureIdDeleteArguments(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Voicebox.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Voicebox.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DeleteCaptureEndpointCapturesCaptureIdDelete",
                                methodName: "DeleteCaptureEndpointCapturesCaptureIdDeleteAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeleteCaptureEndpointCapturesCaptureIdDeleteResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Voicebox.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDeleteCaptureEndpointCapturesCaptureIdDeleteResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
