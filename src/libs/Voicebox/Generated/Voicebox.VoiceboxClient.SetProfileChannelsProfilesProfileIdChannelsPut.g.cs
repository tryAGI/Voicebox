...
namespace Voicebox
{
    ...
    {
        partial void PrepareSetProfileChannelsProfilesProfileIdChannelsPutArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string profileId,
            global::Voicebox.ProfileChannelAssignment request);
        partial void PrepareSetProfileChannelsProfilesProfileIdChannelsPutRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string profileId,
            global::Voicebox.ProfileChannelAssignment request);
        partial void ProcessSetProfileChannelsProfilesProfileIdChannelsPutResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSetProfileChannelsProfilesProfileIdChannelsPutResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> SetProfileChannelsProfilesProfileIdChannelsPutAsync(
            string profileId,
        ...
        {
            var __response = await SetProfileChannelsProfilesProfileIdChannelsPutAsResponseAsync(
                profileId: profileId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Voicebox.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Voicebox.AutoSDKHttpResponse<string>> SetProfileChannelsProfilesProfileIdChannelsPutAsResponseAsync(
            string profileId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareSetProfileChannelsProfilesProfileIdChannelsPutArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Voicebox.PathBuilder(
                                path: $"/profiles/{profileId}/channels",
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Voicebox.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Voicebox.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "SetProfileChannelsProfilesProfileIdChannelsPut",
                                methodName: "SetProfileChannelsProfilesProfileIdChannelsPutAsync",
                                pathTemplate: "$\"/profiles/{profileId}/channels\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSetProfileChannelsProfilesProfileIdChannelsPutResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Voicebox.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSetProfileChannelsProfilesProfileIdChannelsPutResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> SetProfileChannelsProfilesProfileIdChannelsPutAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Voicebox.ProfileChannelAssignment
            {
                ChannelIds = channelIds,
            };

            return await SetProfileChannelsProfilesProfileIdChannelsPutAsync(
                profileId: profileId,
                request: __request,
                requestOptions: requestOptions,
