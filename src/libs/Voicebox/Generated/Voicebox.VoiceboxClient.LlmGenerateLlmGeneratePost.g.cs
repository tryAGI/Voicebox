...
namespace Voicebox
{
    ...
    {
        partial void PrepareLlmGenerateLlmGeneratePostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Voicebox.LLMGenerateRequest request);
        partial void PrepareLlmGenerateLlmGeneratePostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Voicebox.LLMGenerateRequest request);
        partial void ProcessLlmGenerateLlmGeneratePostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessLlmGenerateLlmGeneratePostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Voicebox.LLMGenerateResponse> LlmGenerateLlmGeneratePostAsync(

            global::Voicebox.LLMGenerateRequest request,
            global::Voicebox.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await LlmGenerateLlmGeneratePostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Voicebox.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Voicebox.AutoSDKHttpResponse<global::Voicebox.LLMGenerateResponse>> LlmGenerateLlmGeneratePostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareLlmGenerateLlmGeneratePostArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareLlmGenerateLlmGeneratePostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Voicebox.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Voicebox.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "LlmGenerateLlmGeneratePost",
                                methodName: "LlmGenerateLlmGeneratePostAsync",
                                pathTemplate: "\"/llm/generate\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessLlmGenerateLlmGeneratePostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Voicebox.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessLlmGenerateLlmGeneratePostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Voicebox.LLMGenerateResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Voicebox.AutoSDKHttpResponse<global::Voicebox.LLMGenerateResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Voicebox.LLMGenerateResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Voicebox.LLMGenerateResponse> LlmGenerateLlmGeneratePostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Voicebox.LLMGenerateRequest
            {
                Examples = examples,
                MaxTokens = maxTokens,
                ModelSize = modelSize,
            ...
            return await LlmGenerateLlmGeneratePostAsync(
                request: __request,
                requestOptions: requestOptions,
