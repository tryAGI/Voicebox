...
namespace Voicebox
{
    ...
    {
        partial void PrepareUpdateCaptureSettingsEndpointSettingsCapturesPutArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Voicebox.CaptureSettingsUpdate request);
        partial void PrepareUpdateCaptureSettingsEndpointSettingsCapturesPutRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Voicebox.CaptureSettingsUpdate request);
        partial void ProcessUpdateCaptureSettingsEndpointSettingsCapturesPutResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateCaptureSettingsEndpointSettingsCapturesPutResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Voicebox.CaptureSettingsResponse> UpdateCaptureSettingsEndpointSettingsCapturesPutAsync(

            global::Voicebox.CaptureSettingsUpdate request,
            global::Voicebox.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await UpdateCaptureSettingsEndpointSettingsCapturesPutAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Voicebox.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Voicebox.AutoSDKHttpResponse<global::Voicebox.CaptureSettingsResponse>> UpdateCaptureSettingsEndpointSettingsCapturesPutAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateCaptureSettingsEndpointSettingsCapturesPutArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpdateCaptureSettingsEndpointSettingsCapturesPutRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Voicebox.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Voicebox.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UpdateCaptureSettingsEndpointSettingsCapturesPut",
                                methodName: "UpdateCaptureSettingsEndpointSettingsCapturesPutAsync",
                                pathTemplate: "\"/settings/captures\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateCaptureSettingsEndpointSettingsCapturesPutResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Voicebox.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateCaptureSettingsEndpointSettingsCapturesPutResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Voicebox.CaptureSettingsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Voicebox.AutoSDKHttpResponse<global::Voicebox.CaptureSettingsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Voicebox.CaptureSettingsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Voicebox.CaptureSettingsResponse> UpdateCaptureSettingsEndpointSettingsCapturesPutAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Voicebox.CaptureSettingsUpdate
            {
                AllowAutoPaste = allowAutoPaste,
                AutoRefine = autoRefine,
                ChordPushToTalkKeys = chordPushToTalkKeys,
                ChordToggleToTalkKeys = chordToggleToTalkKeys,
                DefaultPlaybackVoiceId = defaultPlaybackVoiceId,
                HotkeyEnabled = hotkeyEnabled,
                Language = language,
                LlmModel = llmModel,
                PreserveTechnical = preserveTechnical,
                SelfCorrection = selfCorrection,
                SmartCleanup = smartCleanup,
                SttModel = sttModel,
            };

            return await UpdateCaptureSettingsEndpointSettingsCapturesPutAsync(
                request: __request,
                requestOptions: requestOptions,
