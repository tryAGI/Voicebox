...
namespace Voicebox
{
    ...
    {
        partial void PrepareCaptureReadinessEndpointCaptureReadinessGetArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareCaptureReadinessEndpointCaptureReadinessGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessCaptureReadinessEndpointCaptureReadinessGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCaptureReadinessEndpointCaptureReadinessGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Voicebox.CaptureReadinessResponse> CaptureReadinessEndpointCaptureReadinessGetAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Voicebox.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Voicebox.AutoSDKHttpResponse<global::Voicebox.CaptureReadinessResponse>> CaptureReadinessEndpointCaptureReadinessGetAsResponseAsync(
            global::Voicebox.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCaptureReadinessEndpointCaptureReadinessGetArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCaptureReadinessEndpointCaptureReadinessGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Voicebox.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Voicebox.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CaptureReadinessEndpointCaptureReadinessGet",
                                methodName: "CaptureReadinessEndpointCaptureReadinessGetAsync",
                                pathTemplate: "\"/capture/readiness\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCaptureReadinessEndpointCaptureReadinessGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Voicebox.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCaptureReadinessEndpointCaptureReadinessGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return new global::Voicebox.AutoSDKHttpResponse<global::Voicebox.CaptureReadinessResponse>(
