...
namespace Voicebox
{
    ...
    {
        partial void PrepareImportGenerationHistoryImportPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Voicebox.BodyImportGenerationHistoryImportPost request);
        partial void PrepareImportGenerationHistoryImportPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Voicebox.BodyImportGenerationHistoryImportPost request);
        partial void ProcessImportGenerationHistoryImportPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessImportGenerationHistoryImportPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> ImportGenerationHistoryImportPostAsync(

            global::Voicebox.BodyImportGenerationHistoryImportPost request,
            global::Voicebox.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ImportGenerationHistoryImportPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Voicebox.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Voicebox.AutoSDKHttpResponse<string>> ImportGenerationHistoryImportPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareImportGenerationHistoryImportPostArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareImportGenerationHistoryImportPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Voicebox.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Voicebox.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ImportGenerationHistoryImportPost",
                                methodName: "ImportGenerationHistoryImportPostAsync",
                                pathTemplate: "\"/history/import\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessImportGenerationHistoryImportPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Voicebox.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessImportGenerationHistoryImportPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> ImportGenerationHistoryImportPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Voicebox.BodyImportGenerationHistoryImportPost
            {
                File = file,
                Filename = filename,
            };

            return await ImportGenerationHistoryImportPostAsync(
                request: __request,
                requestOptions: requestOptions,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var request = new global::Voicebox.BodyImportGenerationHistoryImportPost
            {
